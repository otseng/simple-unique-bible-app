...
import { getBibleBooks, getBibles, getBibleTextBooks, getCompareVerses, getCrossReferences, getLexicon } from '../../../../../lib/api'
...
export default function Index() {
  ...
  const { data: dataVerses, loading: loadingVerses, error: errorVerses } = getCrossReferences(bookNum, chapter, verse, 'KJV')
